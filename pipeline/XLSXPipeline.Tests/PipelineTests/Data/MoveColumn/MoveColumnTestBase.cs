...
public abstract class MoveColumnTestBase(string? defaultPipelineName = null) : SpecializedPipelineTestBase<MoveColumnAction>(Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "PipelineTests", "Data", "MoveColumn"), defaultPipelineName)
{
